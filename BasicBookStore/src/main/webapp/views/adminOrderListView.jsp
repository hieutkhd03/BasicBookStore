...
<title>OrderList phía Admin</title>
</head>
<body>
					...
					<td>
						...
						<div id="div${orderOfCustomer.orderId}" style="display: none;">
							...
							<c:if
								...
								&nbsp;&nbsp;&nbsp;&nbsp;
								<button
									onclick="onClickAdminOrderConfirm(${orderOfCustomer.orderId},${Constant.DELIVERING_ORDER_STATUS },'${Constant.WAITTING_APPROVE_ACTION }')">Xác
									nhận đơn</button>
							</c:if>
							<c:if
								...
								<br />
								<button
									onclick="onClickAdminOrderConfirm(${orderOfCustomer.orderId},${Constant.DELIVERED_ORDER_STATUS },'${Constant.DELIVERING_ACTION }')">Xác
